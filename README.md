...
- **独立模式（唯一模式）**：数据完全存于本地（Room），无账号、无服务端；支持 JSON 备份导出/导入（含随手记与愿望照片，可跨设备迁移）。
...
| --- | --- | --- | --- | --- | --- |
| v0.3.0 | 2026-09-12 | [`release/风起簿-v0.3.0.apk`](release/风起簿-v0.3.0.apk) | 5 | v0.3.0 | 最新版本：SAF 导出 / 设置页日历授权 / 发布导航 / 2027 节假日（推算版）/ 时机今天边界 / 心语可中断；⚠️ 真机回归（C3/C5）待在荣耀 Android 14 上执行 |
